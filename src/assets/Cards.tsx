function Cards() {
    ...
    return (
        <div className="grid grid-cols-3 grid-rows-3 gap-8 m-8 text-lg">
            <div className="bg-green-400 col-span-1 row-span-1 rounded p-5 transition ease-in-out duration-500 hover:scale-105 hover:shadow-lg">
            ...
            <div className="bg-cyan-400 col-span-1 row-span-2 rounded p-5 transition ease-in-out duration-500 hover:scale-105 hover:shadow-lg">
            ...
            <div className="bg-indigo-400 col-span-1 row-span-3 rounded p-5 transition ease-in-out duration-500 hover:scale-105 hover:shadow-lg">
            ...
            <div className="bg-purple-300 col-span-1 row-span-1 rounded p-5 transition ease-in-out duration-500 hover:scale-105 hover:shadow-lg">
            ...
            <div className="bg-amber-300 col-span-2 row-span-1 rounded p-5 transition ease-in-out duration-500 hover:scale-105 hover:shadow-lg">
